...
namespace Hospital.DAL.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "DoctorEntitySpecializationEntity",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorEntitySpecializationEntity", x => new { x.DoctorsId, x.SpecializationsId });
                    table.ForeignKey(
                        name: "FK_DoctorEntitySpecializationEntity_Doctors_DoctorsId",
                        column: x => x.DoctorsId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DoctorEntitySpecializationEntity_Specializations_SpecializationsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorEntitySpecializationEntity_SpecializationsId",
                table: "DoctorEntitySpecializationEntity",
